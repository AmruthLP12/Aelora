...
export const deleteCurrentSession = async () => {
  try {
    // Deletes the session for the current device only
    await account.deleteSession("current");
    console.log("Current session deleted. User logged out from this device.");
  } catch (error) {
    console.error("Error deleting current session:", error.message);
  }
};
